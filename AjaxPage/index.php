...
if ($_GET["CHECKPOST"]=="editStockPrice") {

  if (isset($_POST["stockID"]) && isset($_POST["NewPriceClass"])   ) {

    $stockID = $_POST["stockID"];
    $NewPriceClass = $_POST["NewPriceClass"];
    ...
    if ($NewPriceClass!=="" ) {
        ...
        if (mysqli_query($conn, " UPDATE stocks SET price='$NewPriceClass' WHERE active ='yes' AND stock_id='$stockID'  LIMIT 1  ")) {
...
if ($_GET["CHECKPOST"]=="printcashSalesReceipt") {
    ...
    $totalAmount = $getRow223["total"];
      ...
      <div class=\"ticket\">
                  <p class=\"centered\">OFFICIAL RECEIPT
                      ...
                      <br>CONTACT : 0547182275 / 0201902269
...
/////////////////////////PRINT PAID DEBTS RECEIPT
if ($_GET["CHECKPOST"]=="printpaidDebtReceipt") {

  $getLoanID = $_POST["getLoanID"];


  $selRe = mysqli_query($conn, "SELECT  dbl.*, pad.* FROM debtors_list dbl, pay_debt pad


                 WHERE dbl.customerID = pad.customer_id
                 AND pad.debt_id = '$getLoanID'
                 AND dbl.active = 'yes'
                 AND pad.active = 'yes'
  ...
  $customerID = $getr["customerID"];
  $name = $getr["name"];
  $mobile = $getr["mobile"];
  $location = $getr["location"];
  $amount_owing = $getr["amount_owing"];
  $amount_paid = $getr["amount_paid"];
  $balance = $getr["balance"];
  $amount_paying = $getr["amount_paying"];
  $dbalance = $getr["dbalance"];
  $receipt_no = $getr["receipt_no"];
  $date_added = $getr["date_added"];
  $staff = $getr["staff"];
  ...
  $balance = number_format($balance, 2);
      ...
      <div class=\"ticket\">
                  <p class=\"centered\">OFFICIAL RECEIPT
                      ...
                      <br>Goaso - Kukuom Road 
                      <br>CONTACT : 0547182275 / 0201902269
                      <br>RECEIPT NO. : $receipt_no 
                      <br>STATUS. :  $statusWord
                      <br>DATE : $date_added 
             ...
             <tr class=\"text-right\">
              <td>
                  AMOUNT OWING : <b style=\"font-size:20px;\">GH&#8373;  $amount_owing</b>  
              </td>
          ...
          <tr class=\"text-right\">
               ...
               AMOUNT PAID: <b style=\"font-size:20px;\">GH&#8373;  $amount_paying</b> 
              </td>
          ...
          <tr class=\"text-right\">
               <td >
               BALANCE: <b style=\"font-size:20px;\">GH&#8373;  $balance</b>
              </td>
